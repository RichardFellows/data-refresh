...
@patch('src.database.pyodbc')
def test_windows_connection_string(mock_pyodbc, windows_db_config, settings):
...
@patch('src.database.pyodbc')
def test_sql_connection_string(mock_pyodbc, sql_db_config, settings):
    from src.database import DatabaseConnection
...
@patch('src.database.pyodbc')
def test_test_connection_success(mock_pyodbc, windows_db_config, settings):
    from src.database import DatabaseConnection
...
@patch('src.database.pyodbc')
def test_test_connection_failure(mock_pyodbc, windows_db_config, settings):
    from src.database import DatabaseConnection
...
@patch('src.database.pyodbc')
def test_database_handler_execute_query(mock_pyodbc, windows_db_config, settings):
...
@patch('src.database.pyodbc')
def test_database_handler_execute_non_query(mock_pyodbc, windows_db_config, settings):
    from src.database import DatabaseConnection, DatabaseHandler
...
@patch('src.database.pyodbc')
def test_get_max_value(mock_pyodbc, windows_db_config, settings):
    from src.database import DatabaseConnection, DatabaseHandler
...
@patch('src.database.pyodbc')
def test_get_table_count(mock_pyodbc, windows_db_config, settings):
    from src.database import DatabaseConnection, DatabaseHandler
